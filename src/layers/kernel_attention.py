...
from torch.nn import Module, Parameter, LayerNorm, Dropout, Linear
...
from torch.nn.modules.transformer import _get_seq_len, _detect_is_causal_mask, _get_clones, _get_activation_fn
...
class KernelMultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, kernel_f, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
